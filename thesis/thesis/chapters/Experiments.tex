...
Let the total volume of all boxes be given by:
\[
\sum_{i=1}^{N} \mathrm{V}(s_i),
\]
and let the container volume be $\mathrm{V}(S)$. 
Similarly, the total weight of all boxes is:
\[
\sum_{i=1}^{N} w_i,
\]
with $W_{\max}$ denoting the maximum allowed container weight.

We define two independent lower bounds based on volume and weight constraints.

\subsection*{Volume-based lower bound}

\[
x_V = \frac{\sum_{i=1}^{N} \mathrm{V}(s_i)}{\mathrm{V}(S)}.
\]

The volume-based lower bound is defined as:
\[
L_{\mathrm{volume}} = \left\lceil x_V \right\rceil + \operatorname{frac}(x_V),
\]
where $\operatorname{frac}(x)$ denotes the fractional part of $x$.

\subsection*{Weight-based lower bound}

\[
x_W = \frac{\sum_{i=1}^{N} w_i}{W_{\max}}.
\]

The weight-based lower bound is defined analogously as:
\[
L_{\mathrm{weight}} = \left\lceil x_W \right\rceil + \operatorname{frac}(x_W).
\]

\subsection*{Final lower bound}

The final lower bound is given as:
\[
...
\hline
Class & $N$ & All + Evol. & All + Volume & MaxDist + Evol. & MaxDist + Volume \\ \hline
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{img/elitist-weights.png}%
    }
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{img/hc-phc-volume.png}%
    }
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{%
    \includegraphics[width=1.3\textwidth]{img/hc-weights.png}%
    }
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{img/comparison-original.png}%
    }
...
\begin{figure}[htbp]
    \centering
        \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{img/comparison-medium.png}%
    }
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{img/comparison-heavy.png}%
    }
